...
## 1. Giới thiệu đề tài
Mục tiêu tổng quát của đề tài là xây dựng một ứng dụng bán quần áo trực tuyến hoạt động trên nền tảng di động, cung cấp đầy đủ các chức năng cần thiết cho cả người dùng và quản trị viên.

### Các mục tiêu cụ thể bao gồm:
* Nghiên cứu và áp dụng các công nghệ phát triển ứng dụng di động đa nền tảng vào việc xây dựng hệ thống.
...
1. **Nguyễn Quốc Chí** - MSV: 23810310390 - Nhiệm vụ: Làm Layout đăng nhập, Layout đăng ký, Layout trang chủ, Trang chủ ứng dụng, Màn hình đăng nhập, Màn hình đăng ký, báo cáo chương 1
...
* React Navigation — điều hướng giữa các màn hình trong ứng dụng (Stack Navigation và Bottom Tab Navigation).
...
2. Kết nối điện thoại và máy tính cùng mạng WiFi.
3. Mở Expo Go và quét mã QR để chạy ứng dụng.
...
![Trang đăng nhập](./assets/dangnhap.png)

---

## Trang đăng ký

![Trang đăng ký](./assets/dangky.png)
...
![Giỏ hàng](./assets/giohang.png)

---

## Thông tin tài khoản

![Thông tin tài khoản](./assets/thongtintaikhoan.png)
...
[▶ Video Demo](https://drive.google.com/file/d/1rtGj7fYh37vrMEpwi5nwduiNX4CID9d4/preview)
